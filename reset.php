...
glyphicon glyphicon-pushpin"></i> About</a>
			...
			<div class = "col-lg-9 well" style = "margin-top:60px;min-height: 62vh;">
				<div class = "alert alert-info">Settings / Reset Database</div>
						<div class = "col-lg-3"></div>
						<div class = "col-lg-6">
                            <center>
                                <h3>Are you sure you want to RESET?</h3>
                            <br>
							<form method = "POST" action = "reset_query.php" enctype = "multipart/form-data">
