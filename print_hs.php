...
<body onload="window.print()">
    <div class="row">
        ...
        width: 50%; text-align: center;">
            ...
            <br>
            <br>
            <p><b>HIGH SCHOOL LABORATORY</b></p>
            <p><b><i>(Flora A. Ibana Campus)</i></b></p>
            <br>
        ...
        <table >
            ...
            <tbody>
                <?php
                    ...
                    if($f_item['department'] == 'high school science department' && $fs_item['category_name'] == $f_item['item_category']){
